...
// only stronk blob can pick this up
bool canBePickedUp(CBlob@ this, CBlob@ byBlob)
{
	return byBlob.hasTag("STRONK");
}
...
void onAttach(CBlob@ this, CBlob@ attached, AttachmentPoint @attachedPoint)
{
	...
	// make em stunned at first
	if (attachedPoint.name == "PICKUP") {
		attached.getSprite().PlaySound("/Stun.ogg");
		attached.Tag("force_knock");
	}
