...
bool canBePickedUp(CBlob@ this, CBlob@ byBlob)
{
	...
	if (friendId == byBlob.getNetworkID() || friend.getTeamNum() == byBlob.getTeamNum()) {
		return true;
	}
	return false;

	// maybe make a knocked out state? for loading to cata?
	// NO , just make it pickable when tamed lol
}
