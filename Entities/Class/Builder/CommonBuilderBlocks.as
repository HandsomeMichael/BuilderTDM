...
void addCommonBuilderBlocks(BuildBlock[][]@ blocks, int team_num = 0, const string&in gamemode_override = "")
{
	...
	// 	AddRequirement(b.reqs, "blob", "mat_stone", "Stone", 20); // a bit more cheaper
	// 	blocks[0].push_back(b);
	// }

	BuildBlock b(0, "unfinishedworkshop", "$unfinishedworkshop$", "Big Workshop\nStand in a wide open space\nand tap this button.");
